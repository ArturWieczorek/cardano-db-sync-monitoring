...
data/cardano-node/<env>.db under the same version label node-monitor.py uses.
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--node-ver", required=True,
                   help="Label tagging this run (e.g. LSM-11.0.1). Match the --node-ver you gave "
                        "node-monitor so the disk series joins the rest of the run.")
    ...
    p.add_argument("--cardano-node-path", default="cardano-node",
                   help="Executable name/path prefix of the cardano-node process (for argv discovery).")
    p.add_argument("--lsm-subdir", default="lsm",
    ...
    p.add_argument("--du-timeout", type=float, default=120.0,
    ...
    p.add_argument("--match-arg", default=None,
